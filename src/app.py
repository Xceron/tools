...
os.environ["STREAMLIT_PAGES_DIR"] = os.path.join(
...
TOOL_CONFIG: Dict[str, ToolConfig] = {
    ...
    "dblp.py": {
        "name": "BibTeX updater",
        "description": "Update a BibTeX file by looking up each entry in DBLP",
...
def main():
    st.set_page_config(page_title="Tools", initial_sidebar_state="collapsed")
